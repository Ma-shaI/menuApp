...
from app.crud.crud_submenu import DEL_SUBMENU_RESULT
from app.service.service_submenu import SUBMENU_NOT_FOUND, TITLE_REGISTERED
...
class TestSubmenu:
    def test_not_found(self, client: TestClient):
        ...
        assert response.json()['detail'] == SUBMENU_NOT_FOUND
