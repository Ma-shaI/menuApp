...
from app.crud.crud_menu import DEL_MENU_RESULT
from app.service.service_menu import MENU_NOT_FOUND, TITLE_REGISTERED
...
class TestMenu:
    def test_not_found(self, client: TestClient):
        ...
        assert response.json()['detail'] == MENU_NOT_FOUND
