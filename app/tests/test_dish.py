...
from app.crud.crud_dish import DEL_DISH_RESULT
from app.service.service_dish import DISH_NOT_FOUND, TITLE_REGISTERED
...
class TestDish:
    def test_not_found(self, client: TestClient):
        ...
        assert response.json()['detail'] == DISH_NOT_FOUND
